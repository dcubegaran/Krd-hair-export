...
export default function QuotePage() {
  ...
  const calculateTotals = () => {
    ...
    const totalValue = selectedProducts.reduce((sum, product) => sum + product.totalPrice, 0)
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      const quoteDataForValidation: Partial<QuoteRequest> = {
        ...
        monthlyVolume: formData.monthlyVolume ? parseFloat(formData.monthlyVolume) : undefined,
        targetPriceRange: formData.targetPriceRange.min && formData.targetPriceRange.max ? {
      ...
      const filteredValidationData = Object.fromEntries(
        Object.entries(quoteDataForValidation).filter(([_, value]) => value !== undefined)
      )
      ...
      if (attachments.length > 0) {
        attachmentUrls = await StorageService.uploadMultipleFiles(
          attachments,
          `quotes/temp-${Date.now()}`
        )
      }

      // Create quote request using the filtered data
      const quoteData: Omit<QuoteRequest, 'id' | 'createdAt' | 'updatedAt'> = {
        ...filteredValidationData,
        currency: formData.targetPriceRange.currency as QuoteRequest['currency'],
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={formData.targetPriceRange.currency} onValueChange={(value) => handleInputChange('targetPriceRange', { ...formData.targetPriceRange, currency: value })}>
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                  ...
                  <div className="bg-muted p-4 rounded-lg">
                    ...
                    <div className="space-y-1 text-sm">
                      ...
                      <div className="flex justify-between font-medium">
                        ...
                        <span>${totalValue.toFixed(2)} {formData.targetPriceRange.currency}</span>
                      </div>
                    </div>
                  </div>
                )}
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="destinationPort">Destination Port (if applicable)</Label>
                  <Input
                    id="destinationPort"
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="competitorProducts">Current Suppliers/Competitor Products</Label>
                  <Textarea
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Input
                      ...
                      onChange={(e) => handleInputChange('targetPriceRange', {
                    ...
                    <Select
                      ...
                      onValueChange={(value) => handleInputChange('targetPriceRange', {
                        ...formData.targetPriceRange,
                        currency: value
                      })}
                    >
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Upload any relevant documents, specifications, or reference images
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
